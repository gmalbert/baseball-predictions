...
_DK_PROP_MAP = {
    ...
    "tal bases": "Total Bases",
    "tal bases (from hs)": "Total Bases",
    "tal bases (from hits)": "Total Bases",
    "hits": "Hits",
    "rbis": "RBI",
    "rbi": "RBI",
    "runs scored": "Runs",
...
_DK_PROP_MAP = {
    ...
    "hits + runs": "Hits+Runs+RBI",
    "runs + rbis": "Hits+Runs+RBI",
    "tt runs rs": "Hits+Runs+RBI",
    "tt runs": "Hits+Runs+RBI",
    "te runs rls": "Hits+Runs+RBI",
    "hits runs b": "Hits+Runs+RBI",
...
def _extract_line(seg):
    if "@" in seg:
        return None
    sl = seg.lower()
    if any(w in sl for w in _SKIP_WORDS):
        return None
